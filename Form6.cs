...
namespace Pets
{
    public partial class Form6 : Form
    {
        public Form6()
        {
            ...
            maskedTextBoxPhone.Mask = "+375(00)-000-00-00";
            maskedTextBoxPhone.Name = "textBox2";
        }
        ...
        private void LoadPetsData()
        {
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                try
                {
                    ...
                    if (dataGridView1.Columns["Спелиальность"] != null) dataGridView1.Columns["Спелиальность"].Width = 250;
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                {
                    connection.Open();
                    string query = "INSERT INTO doctors (FIO, specially, phone) VALUES (@fio, @spec, @phone)";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                textBox4.Text = row.Cells["Спелиальность"].Value.ToString();
        ...
        private void фильтрацияПоСпециальностиToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                {
                    connection.Open();
                    string specQuery = "SELECT DISTINCT specially FROM doctors";
                    MySqlDataAdapter adapter = new MySqlDataAdapter(specQuery, connection);
                    DataTable table = new DataTable();
                    adapter.Fill(table);

                    comboBox2.DataSource = table;
                    comboBox2.DisplayMember = "specially";
                    comboBox2.ValueMember = "specially";
                }
                catch (Exception ex)
                {
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Выберите специальность для фильтрации!");
                return;
            }

            string selectedSpec = comboBox2.SelectedValue.ToString();
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                SELECT 
                    id AS 'ID',
                    FIO AS 'ФИО',
                    specially AS 'Спелиальность',
                    phone AS 'Телефон'
                FROM doctors
                WHERE specially = @spec";

                    MySqlDataAdapter adapter = new MySqlDataAdapter(query, connection);
                    adapter.SelectCommand.Parameters.AddWithValue("@spec", selectedSpec);
